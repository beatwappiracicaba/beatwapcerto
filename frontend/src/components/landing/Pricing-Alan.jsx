  ...
  return (
    <section id="planos" className="py-20 px-6 bg-gradient-to-b from-beatwap-black to-black relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-row gap-6 overflow-x-auto snap-x snap-mandatory md:snap-none md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-8 pb-2 md:pb-0 mb-20 max-w-6xl mx-auto">
          
          {/* 1. PLANO AVULSO */}
          <div className="bg-white/5 border border-white/10 rounded-3xl p-6 hover:border-purple-500/50 transition-all duration-300 flex flex-col snap-center shrink-0 w-[85vw] sm:w-[280px]">
            <div className="mb-4">
          ...
          {/* 2. PLANO MENSAL */}
          <div className="bg-white/5 border border-white/10 rounded-3xl p-6 hover:border-beatwap-gold/50 transition-all duration-300 flex flex-col relative group snap-center shrink-0 w-[85vw] sm:w-[280px]">
          ...
          {/* 3. PLANO ANUAL */}
          <div className="bg-white/5 border border-white/10 rounded-3xl p-6 hover:border-blue-500/50 transition-all duration-300 flex flex-col snap-center shrink-0 w-[85vw] sm:w-[280px]">
            <div className="mb-4 text-center sm:text-left">
